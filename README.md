...
![EC-CUBE](https://img.shields.io/badge/EC--CUBE-C71A36?style=flat-square&logoColor=white)
...
- **Multi-server management** — production Laravel apps across multiple EC2 instances
- **Admin panel development** — Laravel-Admin, Backpack, Filament
- **E-commerce** — EC-CUBE customization, payment gateway integrations
- **Automation** — custom CLI tools for deployment, monitoring, and server orchestration
- **AI-assisted workflows** — building tooling around LLMs for development productivity
